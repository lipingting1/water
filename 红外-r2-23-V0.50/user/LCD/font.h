...
unsigned int code HZ[] = { 			 //16*16汉字编码（与汉字取模顺序一致）
	...
	0xd1a1,0xd1f9,0xd3ad,0xd4f1,0xb7d6,0xd6d3,0xc6e4,0xc7e9,0xcbfb,0xcfea,0xd7dc,		//131
}; 
...
unsigned char code ASCA_small[]={			   //ASCAIIM码（与汉字取模顺序一致） 
	...
	0x42,0x43,0x47,0x49,0x4b,0x4c,0x4d,0x51,0x52,0x53,0x54,	 //B C G I K L M Q R S T   
